...
namespace Piwik\Plugins\DateTimeWidget\Widgets;
...
class GetCurrentlocaltimeinwebsitestimezone extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         * your own category.
         */
        $config->setCategoryId('DateTimeWidget_Utils');
         ...
         */
        $config->setName('DateTimeWidget_Currentlocaltimeinwebsitestimezone');
